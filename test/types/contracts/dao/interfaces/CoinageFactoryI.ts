...
export interface CoinageFactoryIInterface extends utils.Interface {
  functions: {
...
export interface CoinageFactoryI extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CoinageFactoryIInterface;
