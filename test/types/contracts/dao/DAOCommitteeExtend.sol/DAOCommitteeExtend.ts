...
export interface DAOCommitteeExtendInterface extends utils.Interface {
  functions: {
...
export interface DAOCommitteeExtend extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DAOCommitteeExtendInterface;
