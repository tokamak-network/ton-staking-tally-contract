...
export interface CandidateInterface extends utils.Interface {
  functions: {
  ...
  events: {
    ...
    "TransferCoinage(address,address,uint256)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "RoleAdminChanged"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "RoleGranted"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "RoleRevoked"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "TransferCoinage"): EventFragment;
}
...
export interface TransferCoinageEventObject {
  from: string;
  to: string;
  amount: BigNumber;
}
export type TransferCoinageEvent = TypedEvent<
  [string, string, BigNumber],
  TransferCoinageEventObject
>;

export type TransferCoinageEventFilter = TypedEventFilter<TransferCoinageEvent>;

export interface Candidate extends BaseContract {
  ...
  filters: {
    ...
    "TransferCoinage(address,address,uint256)"(
      from?: null,
      to?: null,
      amount?: null
    ): TransferCoinageEventFilter;
    TransferCoinage(
      from?: null,
      to?: null,
      amount?: null
