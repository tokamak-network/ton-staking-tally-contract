...
export interface DAOCommitteeOwnerTestBedInterface extends utils.Interface {
  functions: {
    ...
    "setTargetGrantRole(address,bytes32,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setTargetGrantRole",
    values: [
...
export interface DAOCommitteeOwnerTestBed extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DAOCommitteeOwnerTestBedInterface;
