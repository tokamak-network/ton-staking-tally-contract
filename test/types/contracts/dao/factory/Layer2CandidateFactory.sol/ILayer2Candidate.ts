...
export interface ILayer2CandidateInterface extends utils.Interface {
  functions: {
...
export interface ILayer2Candidate extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ILayer2CandidateInterface;
