...
export interface Layer2CandidateFactoryProxyInterface extends utils.Interface {
  functions: {
...
export interface Layer2CandidateFactoryProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Layer2CandidateFactoryProxyInterface;
