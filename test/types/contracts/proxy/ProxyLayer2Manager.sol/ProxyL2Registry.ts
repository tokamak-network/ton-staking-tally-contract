...
export interface ProxyL2RegistryInterface extends utils.Interface {
  functions: {
...
export interface ProxyL2Registry extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxyL2RegistryInterface;
