...
export interface RefactorCoinageSnapshotProxyInterface extends utils.Interface {
  functions: {
...
export interface RefactorCoinageSnapshotProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RefactorCoinageSnapshotProxyInterface;
