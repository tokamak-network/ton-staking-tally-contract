...
export interface AutoRefactorCoinageProxyInterface extends utils.Interface {
  functions: {
...
export interface AutoRefactorCoinageProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AutoRefactorCoinageProxyInterface;
