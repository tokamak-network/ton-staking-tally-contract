...
export interface SeigManagerProxyInterface extends utils.Interface {
  functions: {
...
export interface SeigManagerProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SeigManagerProxyInterface;
