...
export interface SeigManagerV1_2Interface extends utils.Interface {
  functions: {
...
export interface SeigManagerV1_2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SeigManagerV1_2Interface;
