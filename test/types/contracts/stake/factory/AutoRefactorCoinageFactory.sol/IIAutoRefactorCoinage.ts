...
export interface IIAutoRefactorCoinageInterface extends utils.Interface {
  functions: {
...
export interface IIAutoRefactorCoinage extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IIAutoRefactorCoinageInterface;
