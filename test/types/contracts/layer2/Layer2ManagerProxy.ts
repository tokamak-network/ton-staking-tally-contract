...
export interface Layer2ManagerProxyInterface extends utils.Interface {
  functions: {
...
export interface Layer2ManagerProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Layer2ManagerProxyInterface;
