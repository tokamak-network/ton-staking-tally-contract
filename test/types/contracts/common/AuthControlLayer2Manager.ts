...
export interface AuthControlLayer2ManagerInterface extends utils.Interface {
  functions: {
...
export interface AuthControlLayer2Manager extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AuthControlLayer2ManagerInterface;
