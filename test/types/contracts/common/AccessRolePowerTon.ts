...
export interface AccessRolePowerTonInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "ADMIN_ROLE" | "BURNER_ROLE" | "MINTER_ROLE"
  ): FunctionFragment;
...
export interface AccessRolePowerTon extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AccessRolePowerTonInterface;
